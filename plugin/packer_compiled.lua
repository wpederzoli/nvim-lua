...
_G.packer_plugins = {
  ...
  ["lspsaga.nvim"] = {
    ...
    loaded = true,
    path = "/home/will/.local/share/nvim/site/pack/packer/start/lspsaga.nvim",
  ...
  ["nvim-ts-autotag"] = {
    loaded = true,
    path = "/home/will/.local/share/nvim/site/pack/packer/start/nvim-ts-autotag",
  ...
  ["telescope-file-browser.nvim"] = {
    loaded = true,
    path = "/home/will/.local/share/nvim/site/pack/packer/start/telescope-file-browser.nvim",
